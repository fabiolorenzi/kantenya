...
import termsLogo from "../img/logo.png";

function TermsConditions() {
    return (
        <main className="terms">
            <div className="termsBanner">
                <img src={termsLogo} alt="kantenya's logo" />
            ...
            <div className="conditions">
                ...
                <h2>OVERVIEW</h2>
                <p>
                    This website is operated by Kantenya. Throughout the site, the terms “we”, “us” and “our” refer to Kantenya. 
                    Kantenya offers this website, including all information, tools and services available from this site to you, 
                ...
                <p>
                    ...
                    malware that could in any way affect the operation of the Service or any related website. You may not use a false 
                    e-mail address, pretend to be someone other than yourself, or otherwise mislead us or third-parties as to the 
                    origin of any comments. You are solely responsible for any comments you make and their accuracy. We take no 
                ...
                <p>
                    In no case shall Kantenya, our directors, officers, employees, affiliates, agents, contractors, interns, 
                ...
                <p>
                    You agree to indemnify, defend and hold harmless Kantenya and our parent, subsidiaries, affiliates, partners, 
                ...
                <p>
                    ...
                    construed in accordance with the laws of 5 Fenchurch Walk, Brighton, BN1 4GX, United Kingdom.
                </p>
                ...
                <p id="lastCondition">
                    Questions about the Terms of Service should be sent to us using 
                    <Link to="/contacts" id="conditionsLink"> our inquiry form.</Link>
                </p>
            </div>
        </main>
    );
